...
namespace Ui
{
    public partial class OrderForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Employee employee = new Employee(1, "Rico", "Verhoeven", DateTime.Now, DateTime.Now, Gender.Male, "Pa$$w0rd", EmployeeType.Waiter);
            Table table = new Table(1, 4, false);
            Order order = new Order(1, DateTime.Now, DateTime.Now, dishes, drinks, employee, table, OrderState.Started, "Graag extra veel saus");
